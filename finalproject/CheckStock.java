...
public class CheckStock extends javax.swing.JFrame {
         ...
         public void fillTableStock() throws SQLException{
        try {
                Connect con = new Connect();
                Connection myconObj = con.connect();
                
            DefaultTableModel dtm = new DefaultTableModel();
            String query = "SELECT * FROM `phone information`";
         ...
         public void count() throws SQLException{
             CountStock ci = new CountStock();
             int totalStock = ci.countStock();
             jLabel13.setText(String.valueOf(totalStock));
         }
         
    /**
     * Creates new form AdminOption
     */
    public CheckStock() throws SQLException {
        initComponents();
        fillTableStock();
        count();
    }
